...
export const ReviewsCarousel = memo(function ReviewsCarousel() {
  ...
  return (
    <section id="reviews" className="scroll-mt-20 bg-white py-14 border-t border-[#E5E7EB]">
            ...
            {reviews.map((r, i) => (
              ...
              >
                <div>
                  ...
                  <blockquote className="mt-3.5 text-xs sm:text-sm leading-relaxed text-[#374151]">
                    &ldquo;{r.quote}&rdquo;
                  </blockquote>
                </div>
                ...
                <figcaption className="mt-5 flex items-center gap-3 border-t border-gray-100 pt-3">
                  ...
                  <span className="text-xs sm:text-sm font-bold text-[#111827]">- {r.name}</span>
                </figcaption>
              </figure>
            ))}
          </div>
